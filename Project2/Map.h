...
private:
	...
	bool find(const KeyType& key, Node*& p) const;
	// Return whether the node containing the data was found
	// Have a reference to a Node pointer as a parameter to get that value back
